...
// verifier si l'utilisateur a cliquer ou op
  ...
  <a class="navbar-brand" href="#"><img src="../assets/image/logoo.png"class="logo"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../commande/commande.php"><i class="bi bi-list-ul"></i>Commandes</a>
        </li>
        <li class="nav-item">
...
<div class="butunV">
 <a class="btn btn-outline-info" href="panier.php?action=valider?$var=<?php $valeurT; ?>">Valider </a>
</div>
</div><br><br>
