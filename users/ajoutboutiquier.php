...
$result = $transaction->inscription($nom,$prenom,$adresse, $tel,$pwd,$profile);
...
<form action="ajoutboutiquier.php" method="POST" class="row g-3 boutiquierform">
  ...
  <div class="col-md-6">
    ...
    <input name="nom" type="texte" class="form-control" id="Nom" required> 
  </div>
  <div class="col-md-6">
    <label for="Prenom" class="form-label">Prenom</label>
    <input name="prenom"type="texte" class="form-control" id="Prenom" required>
  </div>
  <div class="col-12">
    <label for="adresse" class="form-label">Adresse</label>
    <input name="adresse" type="text" class="form-control" id="adresse" placeholder="Dakar"required>
  </div>
  <div class="col-md-6">
    <label for="Téléphone" class="form-label">Téléphone</label>
    <input name="tel"type="number" class="form-control" id="Téléphone"required>
  </div>
  <div class="col-md-6">
